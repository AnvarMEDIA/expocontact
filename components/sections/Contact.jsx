                  ...
                  >
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input type="text" required value={form.name} onChange={set('name')} placeholder={t('placeholderName')} className={INPUT_CLASS} />
                      </div>
                      <div>
                        <label className={LABEL_CLASS}>{t('formCompany')}</label>
                        <input type="text" value={form.company} onChange={set('company')} placeholder={t('placeholderCompany')} className={INPUT_CLASS} />
                      </div>
                    </div>
