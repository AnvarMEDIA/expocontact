...
function ServiceRow({ item, index, isOpen, onToggle }) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={onToggle}
        className="w-full flex items-center gap-3 sm:gap-5 py-5 sm:py-6 md:py-7 text-left min-h-[60px]"
        aria-expanded={isOpen}
      >
        {/* Number */}
        <span className={`font-heading font-black text-xs tracking-widest transition-colors duration-300 flex-shrink-0 w-6 sm:w-8 ${
        ...
        {/* Title */}
        <span className={`flex-1 font-heading font-black text-sm sm:text-base md:text-xl transition-colors duration-300 leading-snug ${
      ...
      <AnimatePresence initial={false}>
        {isOpen && (
          ...
          >
            <div className="pb-5 sm:pb-7 pl-9 sm:pl-[3.25rem] md:pl-[4.5rem]">
...
export default function Services() {
  ...
  return (
    <section id="services" className="py-16 sm:py-24 md:py-32 bg-navy relative overflow-hidden">
      {/* Decorative left vertical gold line */}
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-white/40 text-sm sm:text-lg mt-4 sm:mt-5">{t('subtitle')}</p>
        </motion.div>
